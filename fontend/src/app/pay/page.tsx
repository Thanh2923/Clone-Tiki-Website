...
const Page: React.FC = () => {
  ...
  const cartIdItem = cartItems.map(item=>item.id);
 ...
 const handleCheckout = async ()=>{
  ...
  return (
    <div className="w-full p-5 grid gap-5 grid-cols-1 md:grid-cols-1 lg:grid-cols-12 h-full">
      <div className="lg:col-span-8 p-2 bg-white">
        <Title title="Chọn hình thức giao hàng" />
        <div className="w-full">
          <div className="w-[35%] rounded-xl p-5 h-[80px] bg-blue-100">
            <h3 className="text-md mb-1">Giao tiết kiệm <span className="p-1 bg-white rounded-xl text-green-500">-25%</span></h3>
